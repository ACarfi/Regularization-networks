...
af1.set_title('median error')
training, = af1.semilogx(intlambda, tm, 'r')
validation, = af1.semilogx(intlambda, vm, 'b')
af1.legend([training, validation], ['training', 'validation'])
plt.draw()
